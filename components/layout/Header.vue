<template>
  <div class="bg-white flex flex-row justify-between px-8">
    <div class="container mx-auto px-4 py-6 text-white flex items-center">
    ...
    <div class="flex flex-row items-center">
      <div>
        <BaseButton label="Login" variant="outline" class="mr-4"/>
      </div>
      <div>
