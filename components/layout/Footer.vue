<template>
  <footer class="bg-blue-dark text-white px-6 py-12" role="contentinfo" aria-label="Kore footer and newsletter">
    <div class="max-w-[1200px] mx-auto grid gap-12 grid-cols-1 md:grid-cols-[1fr_340px_260px] items-start">
      <div>
        ...
        <p class="text-slate-200 mb-6 max-w-[520px]">
          ...
          <div class="flex gap-4 mb-4 flex-col sm:flex-row">
            <div class="flex-1">
              ...
              <input
                  ...
                  class="w-full px-4 py-3 rounded-md border border-white/20 bg-white text-slate-800 focus:outline-none focus:ring-2 focus:ring-white/30"
              />
            </div>
          ...
          <div class="flex gap-0 flex-col sm:flex-row items-stretch mb-3">
            <label class="flex-1">
              <input
                  ...
                  class="w-full px-4 py-4 rounded-l-md sm:rounded-l-md sm:rounded-r-none border-none outline-none text-slate-700"
              />
            </label>
            ...
            <button
                ...
                class="mt-3 sm:mt-0 bg-[#26375f] hover:bg-[#1f2d4a] disabled:opacity-60 disabled:cursor-not-allowed text-white px-6 py-3 rounded-md sm:rounded-l-none sm:rounded-r-md min-w-[140px] transition"
            >
      ...
      <div aria-label="Site links">
        ...
        <ul class="space-y-2 text-slate-200">
          ...
          <li><a href="#" class="hover:underline">KoreTeam</a></li>
          <li><a href="#" class="hover:underline">KorePartners</a></li>
          <li><a href="#" class="hover:underline">Media</a></li>
        </ul>

        <ul class="space-y-2 text-slate-200 mt-4">
          <li><a href="#" class="hover:underline">GPDR Compliance</a></li>
      ...
      <div aria-label="Follow us">
        ...
        <ul class="space-y-3 text-slate-200">
          <li>
            <a href="#" aria-label="Facebook" class="inline-flex items-center gap-3 hover:underline">
          ...
          <li>
            <a href="#" aria-label="Instagram" class="inline-flex items-center gap-3 hover:underline">
          ...
          <li>
            <a href="#" aria-label="X" class="inline-flex items-center gap-3 hover:underline">
          ...
          <li>
            <a href="#" aria-label="LinkedIn" class="inline-flex items-center gap-3 hover:underline">
